...
public class User implements UserDetails {
    ...
    /**
     * Provides access to the site if the user is not banned.
     */
    @NotBlank(message = "Активность неможет быть пустым")
     ...
     * Between the {@link User} and {@link Good} objects, there is a many-to-many relationship, that is,
    ...
    /**
     * Method for verifying a user with owner rights.
     */
